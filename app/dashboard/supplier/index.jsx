    ...
    return (
        <Layout title="All Suppliers">
            ...
            >
                ...
                <View className="flex flex-row flex-wrap justify-between items-center h-32">
                    {suppliers?.data?.data.map((supplier) => {
                        ...
                        return (
                            <View
                                key={supplier.id}
                                className="bg-white rounded-lg p-3 mb-1 w-[49.5%] h-full justify-center"
                            >
